...
FUNCTIONS=(
  addMessageData addUserData callback echo feedback
  getChatsData getMessageData getProductsData getProductsInfoData getUserData
...
deploy_batch addMessageData addUserData callback echo feedback getChatsData
